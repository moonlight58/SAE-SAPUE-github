...
public class APICommunicationStepDefs {
    ...
    static class MockDataDriver implements DataDriver {
        
        Map<ObjectId, Poubelles> poubelles = new HashMap<>();
        Map<String, Microcontrolleur> mcs = new HashMap<>();
        Releves lastInsertedReleve;
        
        boolean shouldFailNextInsert = false;
    ...
    static class MockSmartWasteServer extends SmartWasteServer {
